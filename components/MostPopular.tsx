...
const destinations = [
    ...
    { price: "$15k", place: "Full Europe", time: "15 Days Trip", url: "/image/books/vibekananda.jpg" },
]
export default function MostPopular() {
    return (
        <section className='relative w-full h-auto flex flex-col items-center mt-20 lg:px-32'>
            <h3 className='text-gray-500 text-center'>Top Selling</h3>
            <h2 className='text-3xl lg:text-5xl text-center'>Most Popular Books</h2>
            <div className='grid grid-cols-1 gap-5 md:grid-cols-3 lg:gap-20 md:gap-5 w-full mt-10'>
            ...
            <img src="/travel/Decore.svg" alt="Decoration" className='absolute top-52 right-5 hidden md:block ' />
